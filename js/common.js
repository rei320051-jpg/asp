...
const i18n = {
    en: {
        ...
        'map.subtitle': 'Drag to rotate · Scroll to zoom · Hover for details',
        'map.loading': 'Loading world map',
        'map.loadingEngine': 'Loading 3D engine',
        'map.loadingMap': 'Drawing world map',
        'map.loadingData': 'Loading accident data',
        'map.ready': 'Ready',
        'map.zoomIn': 'Zoom in',
    ...
    zh: {
        ...
        'map.title': '全球事故地图',
        'map.subtitle': '拖动旋转 · 滚轮缩放 · 悬停查看详情',
        'map.loading': '正在加载世界地图',
        'map.loadingEngine': '加载 3D 引擎',
        'map.loadingMap': '绘制世界地图',
        'map.loadingData': '载入事故数据',
        'map.ready': '就绪',
        'map.zoomIn': '放大',
        'map.zoomOut': '缩小',
        'map.resetView': '重置视图',
